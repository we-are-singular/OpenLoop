  ...
  return (
    <div className="fixed z-50 font-sans">
      ...
      <button
        ...
        style={{ backgroundColor: config.accentColor }}
      >
        {isOpen ? <X size={20} /> : <LogoIcon size={22} />}
      </button>
